...
running command...
$ gateway-eth (--version)
@identity.com/gateway-eth-cli/0.0.3 darwin-arm64 node-v16.17.1
...
USAGE
  $ gateway-eth add-gatekeeper [ADDRESS] [-h] [-p <value>] [-t <value>] [-n <value>] [-c
    ...
    nFuji|starknetMainnet|starknetGoerli] [-f <value>] [-w <value>]
...
FLAGS
  -c, --chain=<option>
      ...
      ancheCChainFuji|starknetMainnet|starknetGoerli>
...
_See code: [dist/commands/add-gatekeeper.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/add-gatekeeper.ts)_
...
_See code: [dist/commands/add-network-authority.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/add-network-authority.ts)_
...
USAGE
  $ gateway-eth create-gatekeeper-network [ID] [NAME] [-h] [-p <value>] [-c
    localhost|mainnet|sepolia|goerli|polygonMumbai|polygonMainnet|auroraTestnet|auroraMainnet|optimismGoerli|optimismMai
    nnet|palmTestnet|palmMainnet|arbitrumGoerli|arbitrumMainnet|celoMainnet|celoAlfajores|avalancheCChain|avalancheCChai
    nFuji|starknetMainnet|starknetGoerli] [-t <value>] [-f <value>] [-w <value>]
...
_See code: [dist/commands/create-gatekeeper-network.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/create-gatekeeper-network.ts)_
...
_See code: [dist/commands/freeze.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/freeze.ts)_
...
USAGE
  $ gateway-eth get-token [ADDRESS] [-h] [-t <value>] [-n <value>] [-c
    localhost|mainnet|sepolia|goerli|polygonMumbai|polygonMainnet|auroraTestnet|auroraMainnet|optimismGoerli|optimismMai
    nnet|palmTestnet|palmMainnet|arbitrumGoerli|arbitrumMainnet|celoMainnet|celoAlfajores|avalancheCChain|avalancheCChai
    nFuji|starknetMainnet|starknetGoerli]
...
_See code: [dist/commands/get-token.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/get-token.ts)_
...
USAGE
  $ gateway-eth issue [ADDRESS] [EXPIRY] [-h] [-p <value>] [-t <value>] [-n <value>] [-c
    localhost|mainnet|sepolia|goerli|polygonMumbai|polygonMainnet|auroraTestnet|auroraMainnet|optimismGoerli|optimismMai
    nnet|palmTestnet|palmMainnet|arbitrumGoerli|arbitrumMainnet|celoMainnet|celoAlfajores|avalancheCChain|avalancheCChai
    nFuji|starknetMainnet|starknetGoerli] [-f <value>] [-w <value>] [-b <value>]
...
_See code: [dist/commands/issue.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/issue.ts)_
...
_See code: [dist/commands/listen.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/listen.ts)_
...
_See code: [dist/commands/refresh.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/refresh.ts)_
...
_See code: [dist/commands/remove-gatekeeper.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/remove-gatekeeper.ts)_
...
_See code: [dist/commands/remove-network-authority.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/remove-network-authority.ts)_
...
_See code: [dist/commands/revoke.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/revoke.ts)_
...
_See code: [dist/commands/unfreeze.ts](https://github.com/identity-com/on-chain-identity-gateway/blob/v0.0.3/dist/commands/unfreeze.ts)_
