...
export interface GatewayTokenInternalsTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DAO_MANAGER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export namespace AuthorizedUpgradeEvent {
  export type InputTuple = [];
  export type OutputTuple = [];
  export interface OutputObject {}
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface GatewayTokenInternalsTest extends BaseContract {
  connect(runner?: ContractRunner | null): GatewayTokenInternalsTest;
  ...
  authorizedUpgrade: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getMsgData: TypedContractMethod<[arg0: BigNumberish], [void], "nonpayable">;

  getMsgSender: TypedContractMethod<[], [void], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "authorizedUpgrade"
  ...
  >;
  getEvent(
    key: "AuthorizedUpgrade"
  ): TypedContractEvent<
    AuthorizedUpgradeEvent.InputTuple,
    AuthorizedUpgradeEvent.OutputTuple,
    AuthorizedUpgradeEvent.OutputObject
  >;
  getEvent(
    key: "BeaconUpgraded"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "AuthorizedUpgrade()": TypedContractEvent<
      AuthorizedUpgradeEvent.InputTuple,
      AuthorizedUpgradeEvent.OutputTuple,
      AuthorizedUpgradeEvent.OutputObject
    >;
