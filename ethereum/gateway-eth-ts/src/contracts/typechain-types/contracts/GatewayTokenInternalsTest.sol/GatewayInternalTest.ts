...
export interface GatewayInternalTestInterface extends utils.Interface {
  functions: {
...
export interface GatewayInternalTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GatewayInternalTestInterface;
  ...
  functions: {
    ...
    getMsgData(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getMsgData(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getMsgData(overrides?: CallOverrides): Promise<PopulatedTransaction>;
