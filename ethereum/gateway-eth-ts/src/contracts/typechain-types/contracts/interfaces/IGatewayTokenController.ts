...
export interface IGatewayTokenControllerInterface extends utils.Interface {
  functions: {
...
export interface IGatewayTokenController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGatewayTokenControllerInterface;
