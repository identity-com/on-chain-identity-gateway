...
export interface IERC3525MetadataUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
...
export interface IERC3525MetadataUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): IERC3525MetadataUpgradeable;
  ...
  slotURI: TypedContractMethod<[_slot: BigNumberish], [string], "view">;
  ...
  ): TypedContractMethod<[_slot: BigNumberish], [string], "view">;
  getFunction(
