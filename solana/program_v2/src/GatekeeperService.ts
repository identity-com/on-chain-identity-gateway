...
export class GatekeeperService extends AbstractService {
    ...
    setState(
        ...
        const instructionPromise = this.getProgram()
            .methods.setPassState(
                EnumMapper.to(state, PassStateMapping),
                subject,
                passNumber
            )
            .accounts({
    ...
    refreshPass(
        ...
        const instructionPromise = this.getProgram()
            .methods.refreshPass(subject, passNumber)
            .accounts({
                pass: passAccount,
                systemProgram: anchor.web3.SystemProgram.programId,
                authority,
    ...
    expirePass(
        ...
        const instructionPromise = this.getProgram()
            .methods.expirePass(subject, passNumber)
            .accounts({
                pass,
                systemProgram: anchor.web3.SystemProgram.programId,
                authority,
    ...
    async getPassAccount(
        ...
        console.log(subject.toBase58(), this._network.toBase58(), passNumber);
