...
@identity.com/solana-gatekeeper-lib/1.0.10 darwin-x64 node-v16.0.0
$ ociv --help [COMMAND]
USAGE
  $ ociv COMMAND
...
...
_See code: [dist/commands/audit.ts](https://github.com/identity-com/gatekeeper-lib/blob/v1.0.10/dist/commands/audit.ts)_
...
_See code: [dist/commands/issue.ts](https://github.com/identity-com/gatekeeper-lib/blob/v1.0.10/dist/commands/issue.ts)_
...
_See code: [dist/commands/revoke.ts](https://github.com/identity-com/gatekeeper-lib/blob/v1.0.10/dist/commands/revoke.ts)_
...
_See code: [dist/commands/verify.ts](https://github.com/identity-com/gatekeeper-lib/blob/v1.0.10/dist/commands/verify.ts)_
<!-- commandsstop -->
